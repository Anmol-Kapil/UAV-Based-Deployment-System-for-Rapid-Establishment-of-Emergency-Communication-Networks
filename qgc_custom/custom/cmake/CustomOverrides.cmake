# ============================================================================
# UAV Emergency GCS — Custom Build Configuration Overrides
# ============================================================================

# ----------------------------------------------------------------------------
# Application Branding
# ----------------------------------------------------------------------------
set(QGC_APP_NAME "UAV-Emergency-GCS" CACHE STRING "App Name" FORCE)
set(QGC_ANDROID_PACKAGE_NAME "org.uav.emergencygcs" CACHE STRING "Android package identifier" FORCE)
...
# ----------------------------------------------------------------------------
# Feature Set Customization — PX4 multirotor only (emergency drone)
# ----------------------------------------------------------------------------
